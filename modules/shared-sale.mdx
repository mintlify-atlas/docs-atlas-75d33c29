...
description: "shared-sale defines the sale entity, BuyState lifecycle, realtime event use cases, and sync logic for AlejoTaller's Android client and operator apps."
---
