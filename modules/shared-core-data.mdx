...
description: "shared-core holds cross-cutting domain primitives; shared-data provides DTOs, mappers, and repository implementations for AlejoTaller Android surfaces."
---
