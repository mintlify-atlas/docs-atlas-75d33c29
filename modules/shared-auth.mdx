...
description: "The shared-auth Kotlin module provides authentication use cases, entities, and repository contracts shared between the AlejoTaller client and operator Android apps."
---
