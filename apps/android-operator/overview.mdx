...
description: "AlejoTallerScan is the operator-facing Android app for scanning QR codes, verifying customer orders, and publishing real-time confirmation events via alejo_publisher."
---
...
| Realtime events | Pusher Java Client |
...
- **shared-auth** — operator authentication and the `OperatorAccess` role check (`operator`, `admin`, `administrator`, `owner`)
