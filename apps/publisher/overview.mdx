...
description: "alejo_publisher is a minimal Node.js/Express microservice that receives operator decisions and publishes real-time sale verification events to Pusher channels."
---
