---
title: "alejo_publisher REST API: Endpoints, Schemas, and Errors"
sidebarTitle: "API Reference"
description: "Full reference for alejo_publisher: GET /health and POST /sale-verification/publish, with request fields, responses, and error codes."
---
