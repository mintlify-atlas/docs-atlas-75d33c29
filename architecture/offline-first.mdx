---
title: "Offline-First Data Architecture: Room, Dexie, and Sync"
sidebarTitle: "Offline-First"
description: "How AlejoTaller uses Room (Android) and Dexie (web) for local-first persistence, with offline fallbacks and sync reconciliation via Appwrite."
---
